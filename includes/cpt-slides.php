...
function saturn_slides_custom_columns($column_name, $id) {
    ...
    } else if ($column_name === 'saturn_slide_video') {
        if (!empty(get_post_meta($id, 'slide-video', true))) {
            echo '<a href="' . get_post_meta($id, 'slide-video', true) . '" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="svg-inline--fa fa-video fa-w-18" data-icon="video" data-prefix="fas" viewBox="0 0 576 512"><defs/><path fill="currentColor" d="M336.2 64H47.8A47.8 47.8 0 000 111.8v288.4A47.8 47.8 0 0047.8 448h288.4a47.8 47.8 0 0047.8-47.8V111.8A47.8 47.8 0 00336.2 64zm189.4 37.7L416 177.3v157.4l109.6 75.5c21.2 14.6 50.4-.3 50.4-25.8V127.5c0-25.4-29.1-40.4-50.4-25.8z"/></svg></a>';
        }
    } else if ($column_name === 'saturn_slide_id') {
        echo $id;
    }
}
